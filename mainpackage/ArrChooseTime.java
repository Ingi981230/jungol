...
public class ArrChooseTime {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ArrChooseTime window = new ArrChooseTime("");
	 ...
	 * @param object 
	 */
//	public ArrChooseTime(String string, Object object) {
//		initialize(string, object);
//	}

	public ArrChooseTime(Object object) {
		initialize(object);
	}
...
//		lblNewLabel_1.setBounds(402, 0, 122, 25);
...
//		String[] arr = ApiDAO.dao.load2(API_VO.apivo);
//		for(int i=0; i<idx; i++) {
//			s += arr[i]+"\n";
//		}
...
//	}
	...
	private void initialize(Object object) {
		...
		JLabel lblNewLabel_5 = new JLabel("New label");
		lblNewLabel_5.setBounds(51, 0, 64, 82);
		lblNewLabel_5.setIcon(new ImageIcon("C:\\Users\\Administrator.User -2022PDJJA\\Desktop\\2222\\\uBC84\uC2A4.JPG"));
		frame2.getContentPane().add(lblNewLabel_5);
		...
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setText("도착지 : "+(String) object);
		lblNewLabel_1.setBounds(391, 0, 122, 25);
		frame2.getContentPane().add(lblNewLabel_1);
		
		
		JTextArea ta_BusInfo = new JTextArea();
		API_VO2.apivo2 = new API_VO2((String)object);
		int idx = ApiDAO.dao.count2(API_VO.apivo);
		
		String s = "[출발지] \t[출발시간] \t[도착예정] \t  [버스등급]\n";
		String[] arr = ApiDAO.dao.load2(API_VO.apivo);
		for(int i=0; i<idx; i++) {
			s += arr[i]+"\n";
		}
